...
/**
 * SupplyChainProjectPage - Page object for Supply Chain project creation/editing
 */
public class SupplyChainProjectPage {
    private final Page page;

    // Page elements - TODO: Add locators
    private final Locator pageHeader;

    public SupplyChainProjectPage(Page page) {
        this.page = page;
