...
/**
 * Scope1Table - Base class for Scope 1 Emissions tables (A, B, C)
 * Can be used directly or extended for table-specific columns
 *
 * Usage:
 * - Scope1TableA tableA = new Scope1TableA(page);
 * - tableA.enterField("fuel", 0, "value");
 */
public class Scope1Table {
    protected final Page page;
    protected final String tablePrefix;

    /**
     * @param page      Playwright Page object
     * @param tableName Table name (e.g., "fuels", "refrigerants", "mobile_combustion")
     */
    public Scope1Table(Page page, String tableName) {
        this.page = page;
        this.tablePrefix = "scope1_" + tableName.toLowerCase();
    }
