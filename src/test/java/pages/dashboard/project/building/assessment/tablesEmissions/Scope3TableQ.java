...
/**
 * Scope3TableQ - Table Q for Scope 3 Emissions (Recycled Materials)
 *
...
public class Scope3TableQ {
    ...
    private static final String ALL_ROWS_PATTERN = "input[ftestcaseref^='scope3_recycled_materials_type_of_material_']";
